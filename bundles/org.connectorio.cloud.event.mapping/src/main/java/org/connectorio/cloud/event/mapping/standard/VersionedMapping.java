...
public class VersionedMapping implements BindableDestination {

  private final BindableDestination delegate;

  public VersionedMapping(BindableDestination delegate) {
  ...
  public String getPath() {
    return "v{version}/" + delegate.getPath();
  }

  @Override
  public List<VariableDefinition> getVariables() {
    List<VariableDefinition> variables = new ArrayList<>();
    variables.add(new StandardVariableDefinition("version"));
